package com.linkloving.taiwan.db.weight;
...
import com.linkloving.taiwan.db.basic.TableRoot;
        ...
        try
        {
            ...
            while(!mCursor.isAfterLast())
            {
                try
                {
                    ...
                    MyLog.e(TAG, "...............userWeight:"+userWeight.toString());
                }
