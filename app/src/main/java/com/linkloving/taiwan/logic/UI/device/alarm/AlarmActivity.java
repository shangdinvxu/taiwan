package com.linkloving.taiwan.logic.UI.device.alarm;
...
public class AlarmActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    private LinearLayout weekLinearLayout1;
    private LinearLayout weekLinearLayout2;
    ...
    private void initData() {
        ...
        if (Integer.parseInt(strAlarm_one[2]) == 0) {
            mLinearLayout.setBackgroundResource(R.drawable.alarm_content_bg);
            mImageView.setImageResource(R.mipmap.btn_off);
            weekLinearLayout.setVisibility(View.GONE);
            tv_showtime.setTextColor(Color.parseColor("#666666"));
            tv_showtime.setText(strTime);
            tv_color = false;
        } else {
            mLinearLayout.setBackgroundResource(R.drawable.alarm_setting_content_bg);
            mImageView.setImageResource(R.mipmap.btn_on);
            weekLinearLayout.setVisibility(View.VISIBLE);
            tv_showtime.setTextColor(Color.parseColor("#0084ad"));
            tv_showtime.setText(strTime);
            tv_color = true;
        }
        ...
        if (Integer.parseInt(strAlarm_two[2]) == 0) {
            mLinearLayout1.setBackgroundResource(R.drawable.alarm_content_bg);
            mImageView1.setImageResource(R.mipmap.btn_off);
            weekLinearLayout1.setVisibility(View.GONE);
            tv_showtime1.setTextColor(Color.parseColor("#666666"));
            tv_showtime1.setText(strAlarm_two[0]);
            tv_color1 = false;
        } else {
            mLinearLayout1.setBackgroundResource(R.drawable.alarm_setting_content_bg);
            mImageView1.setImageResource(R.mipmap.btn_on);
            weekLinearLayout1.setVisibility(View.VISIBLE);
            tv_showtime1.setTextColor(Color.parseColor("#0084ad"));
            tv_showtime1.setText(strAlarm_two[0]);
            tv_color1 = true;
        }
        ...
        if (Integer.parseInt(strAlarm_three[2]) == 0) {
            mLinearLayout2.setBackgroundResource(R.drawable.alarm_content_bg);
            mImageView2.setImageResource(R.mipmap.btn_off);
            weekLinearLayout2.setVisibility(View.GONE);
            tv_showtime2.setTextColor(Color.parseColor("#666666"));
            tv_showtime2.setText(strAlarm_three[0]);
            tv_color2 = false;
        } else {
            mLinearLayout2.setBackgroundResource(R.drawable.alarm_setting_content_bg);
            mImageView2.setImageResource(R.mipmap.btn_on);
            weekLinearLayout2.setVisibility(View.VISIBLE);
            tv_showtime2.setTextColor(Color.parseColor("#0084ad"));
            tv_showtime2.setText(strAlarm_three[0]);
            tv_color2 = true;
        }
    }
    ...
    protected void initListeners() {
        ...
        weekLinearLayout1.setOnClickListener(this);

        mImageView2.setOnClickListener(this);
        weekLinearLayout2.setOnClickListener(this);
    }
