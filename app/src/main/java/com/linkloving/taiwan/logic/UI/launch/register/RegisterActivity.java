package com.linkloving.taiwan.logic.UI.launch.register;
...
import com.linkloving.taiwan.logic.UI.launch.dto.UserTypeConst;
            ...
            switch (what) {
                case CommParams.HTTP_REGISTERED_EMAIL:
                    if (dataFromServer.getErrorCode() == 1) {
                        ...
                        //跳转到目标设置界面
                            startActivity(IntentFactory.start_BodyActivityIntent(RegisterActivity.this));
                        } else {
