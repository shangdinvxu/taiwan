package com.linkloving.taiwan.logic.UI.goal;
...
//    private String BMIDesc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BLEProviderObserverAdapter bleProviderObserverAdapter = new BLEProviderObserverAdapter();
        provider.setBleProviderObserver(bleProviderObserverAdapter);
            ...
            case R.id.layout_calories:
               /* final Dialog alertDialog4=new Dialog(SportGoalActivity.this);
                ...
                AlertDialog dialog3 = new AlertDialog.Builder(SportGoalActivity.this)
                        .setTitle(ToolKits.getStringbyId(SportGoalActivity.this, R.string.unit_cal))
...
*/
    ...
    private class BLEProviderObserverAdapter extends BLEHandler.BLEProviderObserverAdapter{

        @Override
        protected Activity getActivity() {
            return SportGoalActivity.this;
        }

        @Override
        public void updatefor_notifyforsendGoalSuccess() {
            super.updatefor_notifyforsendGoalSuccess();
            MyToast.show(SportGoalActivity.this, R.string.send_goalsuccess, Toast.LENGTH_SHORT);
        }

        @Override
        public void updatefor_notifyforsendGoalFailed() {
            super.updatefor_notifyforsendGoalFailed();
            MyToast.show(SportGoalActivity.this, R.string.send_goalFailed, Toast.LENGTH_SHORT);
        }
    }
