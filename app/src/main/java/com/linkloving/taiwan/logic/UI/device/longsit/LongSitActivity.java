package com.linkloving.taiwan.logic.UI.device.longsit;
...
import com.linkloving.taiwan.logic.UI.device.alarm.PickerView;
...
public class LongSitActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mFrameLayout = (FrameLayout) findViewById(R.id.longsit_framelayout);
        ...
        if (mCheckBox.isChecked()) {
            mFrameLayout.setBackgroundResource(R.drawable.alarm_setting_content_bg);
            mLinearLayout.setVisibility(View.VISIBLE);
            mTextView.setTextColor(Color.parseColor("#0084ad"));
        } else {
            mFrameLayout.setBackgroundResource(R.drawable.alarm_content_bg);
