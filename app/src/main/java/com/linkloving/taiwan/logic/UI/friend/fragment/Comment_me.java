package com.linkloving.taiwan.logic.UI.friend.fragment;
...
//                    保存到本地  判断是否存过  存过直接忽略
    ...
    private class CimmentMeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public CimmentMeAdapter(Context context, List<UserChatDTO> list) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
           ...
           */
            ...
            itemViewHolder.last_time.setText(list.get(position).getLast_time());
            //tuxiang
            //图像以后设置
        ...
        public class ItemViewHolder extends RecyclerView.ViewHolder {
            ...
            public ItemViewHolder(View view) {
                super(view);
                message = (LinearLayout) view.findViewById(R.id.linear_message);
