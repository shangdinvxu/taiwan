package com.linkloving.taiwan.logic.UI.device.handup;
...
public class HandUpActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        if(Disturb_Valid.equals("0")){
            ...
            wurao_layout.setBackgroundResource(R.drawable.alarm_content_bg);
            ...
            wurao_layout.setBackgroundResource(R.drawable.alarm_setting_content_bg);
