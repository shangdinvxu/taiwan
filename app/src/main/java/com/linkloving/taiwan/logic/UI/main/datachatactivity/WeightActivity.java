...
//        btn.setBackground(ContextCompat.getDrawable(WeightActivity.this, R.mipmap.btn_share));
    ...
    //设置图表的一些属性
        ...
        // 设置背景
        mLineChat.setBackgroundColor(getResources().getColor(R.color.yellow_title));
...
//                                                MyLog.e(TAG,"目标  weight:"+ weight);
//                                            }
                                            PreferencesToolkits.setGoalInfo(WeightActivity.this, PreferencesToolkits.KEY_GOAL_WEIGHT, String.valueOf(weight));
                                            float mfloat=Math.abs(weightNow-weight_goal);
//                                            if (SwitchUnit.getLocalUnit(WeightActivity.this) != ToolKits.UNIT_GONG) {
//                                                mfloat =  ToolKits.calcKG2LB(mfloat);
//                                            }
                                            if(mfloat>0){
...
//                }
    ...
    private  class MyWeightAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            float weight = (float) CommonUtils.getScaledDoubleValue(Double.parseDouble(userWeight.getWeight()),1);
            if (SwitchUnit.getLocalUnit(WeightActivity.this) == ToolKits.UNIT_GONG) {
                vh.unit_step.setText(getString(R.string.unit_kilogramme));
            }else {
//                weight = ToolKits.calcKG2LB(weight);
            ...
            if(userWeight!=null&&Float.parseFloat(userWeight.getWeight())!=0){
                vh.textViewcount.setText(weight+"");
            }
