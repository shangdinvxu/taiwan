package com.linkloving.taiwan.logic.UI.launch;
...
import com.linkloving.taiwan.logic.dto.SportDeviceEntity;
    ...
    private void redirectTo()
    {
        ...
        else
        {
            ...
            if(userAuthedInfo==null){
                ...
                MyLog.e(TAG, "User_id:"+ran);
                weightlist.add(new UserWeight(dateString, Integer.toString(userAuthedInfo.getUser_id()), 60 + ""));
                WeightTable.saveToSqliteAsync(AppStartActivity.this, weightlist,Integer.toString(userAuthedInfo.getUser_id()));
                userAuthedInfo.getUserBase().setUser_height(175);
                MyLog.e(TAG,"体重是："+userAuthedInfo.getUserBase().getUser_weight());
            }
            //B0:B4:48:F7:2F:62
//            userAuthedInfo.getDeviceEntity().setLast_sync_device_id("B0:B4:48:F7:2F:62");
//            userAuthedInfo.getDeviceEntity().setDevice_type(MyApplication.DEVICE_BAND);
