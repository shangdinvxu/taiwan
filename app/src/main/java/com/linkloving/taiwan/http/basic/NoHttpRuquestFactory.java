...
import com.linkloving.taiwan.http.DataFromClient;
...
public class NoHttpRuquestFactory {
    ...
    * */
     ...
     * 企业排行榜基础信息请求（昵称 签名）
     */
    public static Request<String> create_Ranking_Count_Basic_Info(String userId, String userTime,String page,String ent_id) {
...
//    }
    ...
    public static Request<String> createModelRequest(int userId,String modelName) {
        ...
        Request<String> request= NoHttp.createStringRequestPost(url_new);
        DataFromClientNew dataFromClient = new DataFromClientNew();
        dataFromClient.setJobDispatchId(JobDispatchConst.THIRD_PARTY_LOGIC_BASE);
