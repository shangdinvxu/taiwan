...
//				    	msg = mHandler.obtainMessage(INDEX_SET_DEVICE_TIME);
				    ...
				    case INDEX_SEND_OAD:
				    	...
				    	//返回一个可以继续OAD的
					    	...
					    	msg.sendToTarget();
				    	break;
					case INDEX_CLOSE_SYNC_HEART:
						msg=mHandler.obtainMessage();
						msg.what=MSG_BLE_DATA;
						msg.arg1 = INDEX_CLOSE_SYNC_HEART;
						msg.obj = mLepaoProtocalImpl.SyncHeart(serverDeviceInfo.close);
						msg.sendToTarget();
				    	break;
					case INDEX_OPEN_SYNC_HEART:
						msg=mHandler.obtainMessage();
						msg.what=MSG_BLE_DATA;
						msg.arg1 = INDEX_OPEN_SYNC_HEART;
						msg.obj = mLepaoProtocalImpl.SyncHeart(serverDeviceInfo.open);
						msg.sendToTarget();
						break;
